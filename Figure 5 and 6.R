...
source("model.R")
seed <- 270
load(paste0("samples_", 1, "_", seed, ".RData"))
samples_1 <- samples
load(paste0("samples_", 10, "_", seed, ".RData"))
samples_10 <- samples
load(paste0("samples_", 100, "_", seed, ".RData"))
samples_100 <- samples
rm(samples); gc()
## KL values (from KL_divergence script) ---- 
...
## device ----
pdf(file = paste0("compare_plots_", seed, ".pdf"),
...
dev.off()
## device ----
pdf(file = paste0("compare_posterior_potentials_", seed, ".pdf"), height = 4.5, width = 6.25)
