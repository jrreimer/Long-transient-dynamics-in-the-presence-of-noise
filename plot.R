...
## device ----
pdf(file = paste0("trace_plots_", N_trajectories, "_", seed, ".pdf"))
## trace plots ----
...
dev.off()
## device ----
pdf(file = paste0("posterior_potentials_", N_trajectories, "_", seed, ".pdf"), width = 10)
## potential curves ----
...
dev.off()
## device ----
pdf(file = paste0("posterior_deterministic_core_", N_trajectories, "_", seed, ".pdf"), width = 10)
## deterministic core ----
